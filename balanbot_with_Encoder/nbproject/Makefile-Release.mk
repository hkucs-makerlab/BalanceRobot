...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/balanbot_with_encoder: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/balanbot_with_encoder ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/Identity.o: Identity.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Identity.o Identity.cpp
...
${OBJECTDIR}/LEDClass.o: LEDClass.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LEDClass.o LEDClass.cpp

${OBJECTDIR}/MotorDriver.o: MotorDriver.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotorDriver.o MotorDriver.cpp

${OBJECTDIR}/MotorEncoder.o: MotorEncoder.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotorEncoder.o MotorEncoder.cpp

${OBJECTDIR}/PIDClass.o: PIDClass.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PIDClass.o PIDClass.cpp

${OBJECTDIR}/RotaryEncoder.o: RotaryEncoder.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RotaryEncoder.o RotaryEncoder.cpp

${OBJECTDIR}/ServoClass.o: ServoClass.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ServoClass.o ServoClass.cpp

${OBJECTDIR}/SoftPWM.o: SoftPWM.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SoftPWM.o SoftPWM.cpp
...
${OBJECTDIR}/UDPClass.o: UDPClass.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UDPClass.o UDPClass.cpp
